                ...
                <div class="d-flex align-items-center">
                    ...
                    {else}
                        ...
                        <div class="dropdown d-inline-block">
                            <a href="{site_url('register')}" type="button" class="btn header-item noti-icon waves-effect waves-light d-flex align-items-center" data-toggle="tooltip" data-original-title="Регистрация">
                        ...
                        {/if}
                        <div class="dropdown d-inline-block">
                            <a href="{site_url('login')}" type="button" class="btn header-item noti-icon waves-effect waves-light d-flex align-items-center" data-toggle="tooltip" data-original-title="Вход">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/">
                                    <i class="bx bx-home-smile"></i>{__('Главная')}
                                </a>
                            </li>
                        </ul>
                    </div>
